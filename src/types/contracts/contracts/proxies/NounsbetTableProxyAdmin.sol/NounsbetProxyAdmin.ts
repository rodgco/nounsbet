...
export interface NounsbetProxyAdminInterface extends utils.Interface {
  functions: {
...
export interface NounsbetProxyAdmin extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NounsbetProxyAdminInterface;
